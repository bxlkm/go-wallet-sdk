...
import (
	...
	"github.com/bxlkm/go-wallet-sdk/coins/bitcoin"
...
func TestMergePsbt(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, int64(255), bitcoin.GetTxVirtualSize(btcutil.NewTx(buyerSignedTx)))
...
func TestPsbtBatch(t *testing.T) {
	...
	assert.Equal(t, "", sellerPsbt2)
