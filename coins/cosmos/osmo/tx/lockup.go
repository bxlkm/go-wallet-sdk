...
func (m *MsgLockTokens) MessageName() string {
	return "osmosis.lockup.MsgLockTokens"
}

func (m *MsgBeginUnlockingAll) MessageName() string {
	return "osmosis.lockup.MsgBeginUnlockingAll"
}

func (m *MsgBeginUnlocking) MessageName() string {
	return "osmosis.lockup.MsgBeginUnlocking"
}

func (m *MsgExtendLockup) MessageName() string {
	return "osmosis.lockup.MsgExtendLockup"
}
...
func (m *MsgLockTokens) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n1, err1 := types.StdDurationMarshalTo(m.Duration, dAtA[i-types.SizeOfStdDuration(m.Duration):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
	i = types.EncodeVarintTx(dAtA, i, uint64(n1))
	i--
	dAtA[i] = 0x12
	if len(m.Owner) > 0 {
		i -= len(m.Owner)
...
func (m *MsgBeginUnlocking) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ID != 0 {
		i = types.EncodeVarintTx(dAtA, i, uint64(m.ID))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Owner) > 0 {
...
func (m *MsgExtendLockup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n2, err2 := types.StdDurationMarshalTo(m.Duration, dAtA[i-types.SizeOfStdDuration(m.Duration):])
	if err2 != nil {
		return 0, err2
	}
	i -= n2
	i = types.EncodeVarintTx(dAtA, i, uint64(n2))
	i--
	dAtA[i] = 0x1a
	if m.ID != 0 {
		i = types.EncodeVarintTx(dAtA, i, uint64(m.ID))
...
func init() {
	types.RegistryMessageConverter("osmosis/lockup/lock-tokens", func(s string) *types.Any {
		msg := MsgLockTokens{}
	...
	types.RegistryMessageConverter("osmosis/lockup/begin-unlock-tokens", func(s string) *types.Any {
	...
	types.RegistryMessageConverter("osmosis/lockup/begin-unlock-period-lock", func(s string) *types.Any {
