...
type SwapAmountInRoute struct {
	PoolId        uint64 `protobuf:"varint,1,opt,name=poolId,json=poolId,proto3" json:"poolId,string,omitempty"`
...
type SwapAmountOutRoute struct {
	PoolId       uint64 `protobuf:"varint,1,opt,name=poolId,proto3" json:"poolId,string,omitempty"`
...
type SwapAmountInSplitRoute struct {
	...
	TokenInAmount cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=tokenInAmount,proto3,customtype=cosmossdk.io/math.Int" json:"tokenInAmount"`
}

type SwapAmountOutSplitRoute struct {
	Pools          []SwapAmountOutRoute  `protobuf:"bytes,1,rep,name=pools,proto3" json:"pools" yaml:"pools"`
	TokenOutAmount cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=tokenOutAmount,proto3,customtype=cosmossdk.io/math.Int" json:"tokenOutAmount"`
}
...
type MsgSwapExactAmountIn struct {
	...
	TokenOutMinAmount cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=tokenOutMinAmount,proto3,customtype=cosmossdk.io/math.Int" json:"tokenOutMinAmount"`
}
...
type MsgSwapExactAmountOut struct {
	...
	TokenInMaxAmount cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=tokenInMaxAmount,proto3,customtype=cosmossdk.io/math.Int" json:"tokenInMaxAmount"`
...
type MsgSplitRouteSwapExactAmountOut struct {
	...
	TokenInMaxAmount cosmossdk_io_math.Int     `protobuf:"bytes,4,opt,name=tokenInMaxAmount,proto3,customtype=cosmossdk.io/math.Int" json:"tokenInMaxAmount"`
}
...
func (m *MsgSwapExactAmountIn) MessageName() string {
	return "osmosis.poolmanager.v1beta1.MsgSwapExactAmountIn"
}

func (m *MsgSwapExactAmountOut) MessageName() string {
	return "osmosis.poolmanager.v1beta1.MsgSwapExactAmountOut"
}

func (m *MsgSplitRouteSwapExactAmountIn) MessageName() string {
	return "osmosis.poolmanager.v1beta1.MsgSplitRouteSwapExactAmountIn"
}

func (m *MsgSplitRouteSwapExactAmountOut) MessageName() string {
	return "osmosis.poolmanager.v1beta1.MsgSplitRouteSwapExactAmountOut"
}

func init() {
	types.RegistryMessageConverter("osmosis/poolmanager/swap-exact-amount-in", func(s string) *types.Any {
	...
	types.RegistryMessageConverter("osmosis/poolmanager/swap-exact-amount-out", func(s string) *types.Any {
	...
	types.RegistryMessageConverter("osmosis/poolmanager/split-amount-in", func(s string) *types.Any {
	...
	types.RegistryMessageConverter("osmosis/poolmanager/split-amount-out", func(s string) *types.Any {
