...
type MsgExecuteContract struct {
	...
	ExecuteMsg json.RawMessage `protobuf:"bytes,3,opt,name=execute_msg,json=executeMsg,proto3,casttype=encoding/json.RawMessage" json:"execute_msg,omitempty" yaml:"execute_msg"`
...
func (m *MsgSwap) MessageName() string {
	return "terra.market.v1beta1.MsgSwap"
}

func (m *MsgSwapSend) MessageName() string {
	return "terra.market.v1beta1.MsgSwapSend"
}
...
func (m *MsgSwap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AskDenom) > 0 {
		...
		i = types.EncodeVarintTx(dAtA, i, uint64(len(m.AskDenom)))
		i--
		dAtA[i] = 0x1a
	}
	{
	...
	if len(m.Trader) > 0 {
		...
		i = types.EncodeVarintTx(dAtA, i, uint64(len(m.Trader)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *MsgSwapSend) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ToAddress) > 0 {
		...
		i = types.EncodeVarintTx(dAtA, i, uint64(len(m.ToAddress)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.FromAddress) > 0 {
		...
		i = types.EncodeVarintTx(dAtA, i, uint64(len(m.FromAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MsgExecuteContract) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExecuteMsg) > 0 {
		...
		i = types.EncodeVarintTx(dAtA, i, uint64(len(m.ExecuteMsg)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Contract) > 0 {
		...
		i = types.EncodeVarintTx(dAtA, i, uint64(len(m.Contract)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Sender) > 0 {
